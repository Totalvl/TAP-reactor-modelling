...
def solver(CI, dt, f, T, thetaI, opts, pars, er=0.000001,
           user_action=None):
    """
...
#         print('Solving 1 eqation ', t3)
        ...
        while erv > er*np.max(v0) or eru > er*np.max(u0):
            v0[Nx[1]:Nx[2]] = (b21*u0[Nx[1]:Nx[2]]+v_n[Nx[1]:Nx[2]])/(1+b22+b21*u0[Nx[1]:Nx[2]])
            ...
            v1[Nx[1]:Nx[2]] = (b21*u1[Nx[1]:Nx[2]]+v_n[Nx[1]:Nx[2]])/(1+b22+b21*u1[Nx[1]:Nx[2]])
            v1[v1 < 0] = 0
            v1[v1 > 1] = 1
